						...
						<div class="wpr-flex-1">
							...
							<form id="wpr-engage-form" class="wpr-flex wpr-items-center wpr-gap-2">
								...
								<?php else : ?>
									...
									<input id="wpr-engage-email" type="email" required placeholder="<?php echo esc_attr( $email_placeholder ?: __( 'Enter your email', 'wprobo-engage-lite' ) ); ?>" class="wpr-p-2 wpr-border wpr-border-gray-300 wpr-rounded wpr-min-w-[250px]">
								<?php endif; ?>
